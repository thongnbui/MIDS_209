...
import argparse
parser = argparse.ArgumentParser(description='genenerate n points between 2 points')
parser.add_argument('input_2pts', help='2 points coordinates (x1,y1,x2,y2')
parser.add_argument('circle_1_2', help='cicle 1 or 2')
parser.add_argument('n', help='number of point')
args = parser.parse_args()
arr = args.input_2pts.split(',')

#ARG[420,582] -> US [308,319]
points = getPoints(int(arr[0]),int(arr[1]),int(arr[2]),int(arr[3]),int(args.n),int(args.circle_1_2))
